<div class="row gx-md-3 gy-4 mb-4">
    <?php
               ...
               $term_slug = 'post-benefits';  // Replace with the slug of the term
                ...
                if ($query->have_posts()) {
                    while ($query->have_posts()) {
                        ...
                        echo '<h3 class="fs-4 mb-4 lh-sm">POST-ACCIDENT BENEFITS ' . get_the_title() ." [  From: " . $pre_job_from_date  ."  To: " . $pre_job_to_date .  ' ]</h3>';
